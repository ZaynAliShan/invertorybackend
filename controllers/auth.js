...
const register = async (req, res) => {
  ...
  console.log('Token Generated By Backend-Register:', token); // Log the generated token


  res.cookie('token', token, {
    httpOnly: true,
    sameSite: 'None', // Use 'Strict' or 'Lax' if both frontend and backend are on the same domain
    secure: true, // use secure in production
    maxAge: 1000 * 60 * 60 * 24, // set your desired max age for the cookie
  });
...
const login = async (req, res) => {
  ...
  console.log('Token Generated By Backend:', token); // Log the generated token
